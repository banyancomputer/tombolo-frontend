...
const Authed = () => {
  ...
  const fileViewColumns = [
    ...
    {
      name: "DEAL",
      selector: (row: File) => row.Deal,
      sortable: true,
      cell: (row: File) => row.Deal,
    },
    {
      name: "FILE TYPE",
      selector: (row: File) => row.file_type,
      sortable: true,
      cell: (row: File) => row.file_type,
    },
    {
      name: "FILE SIZE",
      selector: (row: File) => row.file_size,
      sortable: true,
      cell: (row: File) => row.file_size + " TiB",
    },
    {
      name: "PROVIDER ID",
      selector: (row: File) => row.provider_id,
      sortable: true,
      cell: (row: File) => "#" + row.provider_id,
    },
  ];
  ...
  // note to alex about change, if done other way, need 20+ clicks for "Data Retrival Request and Request Termination"
          ...
          <div className="xs:hidden md:block">
            ...
            <div className="border-t-2 border-t-[#000] pb-44">
              <div className="flex mt-4">
                ...
                <Button onClick={handleOverview}>BACK</Button>
            ...
            {showFileView ? (
              ...
              <DataTable
                ...
                data={deals} // for alex: change to file data
